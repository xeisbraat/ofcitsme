...
(function () {
    ...
    $(document).ready(function () {
        var links = [
            {
                name: 'Insta',
                link: 'https://instagram.com/mladibossboy'
            },
            
            {
                name: 'Youtube',
                link: 'https://www.youtube.com/channel/UCvQGPSWNCxN0m2lIi8xO7IQ'
            },
		
	    {
                name: 'Discord',
                link: 'https://discord.gg/NGxPnBxw7D'
            }            
        ];
    ...
    (function () {
        $.getJSON('https://freegeoip.app/json/', function (data) {
            ...
            writeLine(["Authenticating...", "Granting access to <span style='font-size: 14px; color: #06d;'>[xeis. site]</span>..."], 30, function () {
                ...
                writeLine(["Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>", "Welcome back, <i style='color: #0f0'>" +  ((data.ip) ? data.ip : usernames[Math.floor(Math.random()*usernames.length)]) 
                    ...
                    writeLine(["<i style='color: #F62459'>xeis.#0001</i>"], 120, 500, function () {
